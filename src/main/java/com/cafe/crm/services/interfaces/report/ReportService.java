...
public interface ReportService {
    void
    createDateClientData(String fileName, LocalDate startDate, LocalDate endDate, List<Integer> weekDays);
    ...
    List<Pair<Product,List<SaleProductOnDay>>> getProductOnDays(LocalDate startDate, LocalDate endDate, String weekDaysTemplate, String productIdTemplate);
